...
export default function QRCodeModal({ isOpen, onClose, submissionResult, language }: QRCodeModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-8 border w-11/12 max-w-3xl shadow-lg rounded-lg bg-white">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <h2 className="text-xl text-center mb-8 text-gray-800">
          Thank you, we have received your Customs Declaration form
        </h2>
        ...
        <div className="text-center mb-6">
          <p className="text-gray-600 text-sm leading-relaxed">
            Please print or download it on your device, then show the QR code or mention the registration code
            to the Customs officer at the terminal or local Customs Service Office to complete this registration.
          </p>
        </div>
        ...
        <div className="border-t pt-6">
          <p className="text-gray-500 text-sm text-center">
            Your data is stored in this device&apos;s browser cache. You can clear the cache in your browser
            or click the button below to delete it.
          </p>
        </div>
      </div>
    </div>
