            ...
            <div className="bg-blue-900 border border-blue-700 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  <p className="text-blue-200 font-medium mb-1">Legal Disclaimer</p>
                  <p className="text-blue-300">
                    eCustoms is not affiliated with or endorsed by the Indonesian Customs and Excise Directorate General (Direktorat Jenderal Bea dan Cukai). This is an independent tool designed with Customs Officials assist travelers in preparing their customs declarations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 mt-6 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-400 text-sm">
              © 2025 eCustoms Indonesia Customs Declaration.
            </p>
          </div>
        </div>
      </div>
